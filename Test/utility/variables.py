...
class Paths:
    WORK_PATH = "/content/benajTest/BOT_WORK"
    THMB_PATH = "/content/benjaTest/colab_leecher/Thumbnail.jpg"
    VIDEO_FRAME = f"{WORK_PATH}/video_frame.jpg"
    HERO_IMAGE = f"benjaTest/Hero.jpg"
    DEFAULT_HERO =  "/content/benjaTest/custom_thmb.jpg"
